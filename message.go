...
func (m *MiniProgram) SendSubscribeMessage(param SendSubscribeMessage) (result *SendSubscribeMessageRsp, err error) {
...
func (m *MiniProgram) SendUniformMessage(param SendUniformMessage) (result *SendUniformMessageRsp, err error) {
...
func (m *MiniProgram) SendCustomerServiceMessage(param SendCustomerServiceMessage) (result *SendCustomerServiceMessageRsp, err error) {
...
func (o *OfficialAccount) SendTemplateMessage(param SendTemplateMessage) (result *SendTemplateMessageRsp, err error) {
